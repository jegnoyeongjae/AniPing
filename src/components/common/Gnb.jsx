        ...
        <div id="Gnb" ref={gnbRef}>
            ...
            <nav className="gnb" onMouseLeave={handleMouseLeaveGnb}>
                <ul className="depth1">
                            ...
                            <div className="depth2-inner">
                                <div className="depth2-menu">
                                    <ul>
                                        ...
                                        <li><Link to='/list/sf'>미스터리</Link></li>
                                        <li><Link to='/list/normal'>SF</Link></li>
                                        <li><Link to='/list/mystery'>일상</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <li className="has2" onMouseEnter={handleMouseEnterDepth1}>
                        <Link to="">
                            <span>카테고리 추가할거 있음 여기 없음 지웡</span>
                        </Link>
                        <div className="depth2">
                            <div className="depth2-inner">
                                <div className="depth2-menu">
                                    <ul>
                                        <li>
                                            <Link to="/chaRankPage">1</Link>
                                        </li>
                                        <li>
                                            <Link to="/chaLine">2</Link>
                                        </li>
                                        <li>
