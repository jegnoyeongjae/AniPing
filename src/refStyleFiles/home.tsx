  ...
  const renderCategory = (category: string, title: string) => (
    <section className="my-32 px-6 md:px-12 relative">
      <div className="flex items-center justify-between mb-12">
        ...
        <Link href={`/category/${category}`} className="group flex items-center gap-2 text-sm font-bold text-primary hover:text-accent transition-all px-6 py-2 rounded-full border border-blue-100 hover:border-accent">
          ...
          >
            <SwiperSlide>
                <div className="relative w-full h-full group cursor-pointer">
                    <img src="/images/banner/SAO.png" alt="배너1" className="w-full h-full object-cover transition-transform duration-[20s] group-hover:scale-105" onError={(e) => { (e.target as any).src = 'https://images.unsplash.com/photo-1542332213-31f87348057f?auto=format&fit=crop&q=80&w=1200' }} />
            ...
            <SwiperSlide>
                <div className="relative w-full h-full group cursor-pointer">
                    <img src="/images/banner/demon.png" alt="배너2" className="w-full h-full object-cover transition-transform duration-[20s] group-hover:scale-105" onError={(e) => { (e.target as any).src = 'https://images.unsplash.com/photo-1528460033278-a6ba57020470?auto=format&fit=crop&q=80&w=1200' }} />
                    <div className="absolute inset-0 bg-gradient-to-t from-primary/40 via-transparent to-transparent"></div>
                    <div className="absolute bottom-20 left-16 text-white max-w-xl">
            ...
            <SwiperSlide>
                <div className="relative w-full h-full group cursor-pointer">
                    <img src="/images/banner/oshi1.png" alt="배너4" className="w-full h-full object-cover transition-transform duration-[20s] group-hover:scale-105" onError={(e) => { (e.target as any).src = 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&q=80&w=1200' }} />
                    <div className="absolute inset-0 bg-gradient-to-t from-primary/40 via-transparent to-transparent"></div>
                    <div className="absolute bottom-20 left-16 text-white max-w-xl">
                            ...
                            <SwiperSlide>
                                <a href="https://maplestory.nexon.com/promotion/event/2025/20250607/event01" target="_blank" rel="noopener noreferrer" className="block w-full h-full bg-white group">
                                    <div className="flex items-center justify-center h-full p-8 transition-transform group-hover:scale-95">
                                        <img src="/images/banner/ad/maple2.png" alt="광고1" className="max-h-full w-auto object-contain" onError={(e) => { (e.target as any).src = 'https://api.iconify.design/logos:nexon.svg' }} />
                                    </div>
                                </a>
                            </SwiperSlide>
                            <SwiperSlide>
                                <a href="https://www.worldjob.or.kr/new_index.do" target="_blank" rel="noopener noreferrer" className="block w-full h-full bg-white group">
                                    <div className="flex items-center justify-center h-full p-8 transition-transform group-hover:scale-95">
                                        <img src="/images/banner/ad/job2.jpg" alt="광고2" className="max-h-full w-auto object-contain" onError={(e) => { (e.target as any).src = 'https://api.iconify.design/logos:google.svg' }} />
                                    </div>
                                </a>
                            </SwiperSlide>
                        </Swiper>
